...
| Change password (self-service) | ✅ | landed 2026-09-14 (Changes.md Part 74): `POST /api/{learner,tutor,admin}/profile/password`, `ChangePasswordForm` on the profile-edit page (learner/tutor) and `/admin/settings` (admin) |
