...
`docs/backlog/TODO.txt`: *"Admin topic/subject management page (add/edit topics &
...
- `docs/reference/feature-checklist.md` — mark the admin subject/topic management item
...
- `docs/reference/erd.md` — regenerated by `prisma generate`.
- `docs/backlog/TODO.txt` — remove the item.
