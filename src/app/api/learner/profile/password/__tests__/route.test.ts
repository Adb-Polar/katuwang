...
import { POST } from "@/app/api/learner/profile/password/route";

function makeRequest(body: unknown) {
  return new NextRequest("http://localhost/api/learner/profile/password", {
    method: "POST",
...
describe("POST /api/learner/profile/password", () => {
  ...
  it("401 when the session role is not STUDENT_LEARNER", async () => {
