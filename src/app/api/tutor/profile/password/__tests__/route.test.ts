...
import { POST } from "@/app/api/tutor/profile/password/route";

function makeRequest(body: unknown) {
  return new NextRequest("http://localhost/api/tutor/profile/password", {
    method: "POST",
...
describe("POST /api/tutor/profile/password", () => {
  ...
  it("401 when the session role is not STUDENT_TUTOR", async () => {
